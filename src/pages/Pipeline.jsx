  ...
  return (
    <>
      <div style={containerStyle}>
        <div className="card p-4 mb-4 mx-3">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  The Trust plans to launch free coaching classes for the poor
                  and needy students. The programme aims to provide free
                  education to children who do not have the means to access
                  formal education. It is an opportunity to educate
                  underprivileged children and provide them with the necessary
                  skills and knowledge to become active members of the society.
                </p>
              </div>
            </div>
          </div>
